...
class KinovaIKSolver:
    """
    Inverse Kinematics & Forward Kinematics Solver mit Pinocchio (Levenberg-Marquardt Algorithmus).
    """
    ...
    def solve_position(
        ...
        """
        Berechnet 6 Gelenkwinkel für eine 3D-Zielposition (x, y, z) in Metern im Base-Frame.
        """
        if not self.is_available or self.model is None:
            return None
